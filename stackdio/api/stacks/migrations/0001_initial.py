    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('global_overstate_file', stackdio.core.fields.DeletingFileField(default=None, upload_to=stackdio.api.stacks.models.get_global_orchestrate_file_path, storage=django.core.files.storage.FileSystemStorage(location=settings.STACKDIO_CONFIG.salt_core_states), max_length=255, blank=True, null=True)),
