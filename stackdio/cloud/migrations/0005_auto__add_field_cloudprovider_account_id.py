...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudProvider.account_id'
        db.add_column(u'cloud_cloudprovider', 'account_id',
                      self.gf('django.db.models.fields.CharField')(default=1234567890, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudProvider.account_id'
        db.delete_column(u'cloud_cloudprovider', 'account_id')
