...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudProvider.global_orch_props_file'
        db.add_column(u'cloud_cloudprovider', 'global_orch_props_file',
                      self.gf('core.fields.DeletingFileField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudProvider.global_orch_props_file'
        db.delete_column(u'cloud_cloudprovider', 'global_orch_props_file')
