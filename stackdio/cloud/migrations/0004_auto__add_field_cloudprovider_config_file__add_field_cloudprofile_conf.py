...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudProvider.config_file'
        db.add_column(u'cloud_cloudprovider', 'config_file',
                      self.gf('core.fields.DeletingFileField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CloudProfile.config_file'
        db.add_column(u'cloud_cloudprofile', 'config_file',
                      self.gf('core.fields.DeletingFileField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudProvider.config_file'
        db.delete_column(u'cloud_cloudprovider', 'config_file')

        # Deleting field 'CloudProfile.config_file'
        db.delete_column(u'cloud_cloudprofile', 'config_file')
