...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SaltRole.role_name'
        db.delete_column(u'stacks_saltrole', 'role_name')

        # Adding field 'SaltRole.sls_path'
        db.add_column(u'stacks_saltrole', 'sls_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SaltRole.role_name'
        db.add_column(u'stacks_saltrole', 'role_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Deleting field 'SaltRole.sls_path'
        db.delete_column(u'stacks_saltrole', 'sls_path')
