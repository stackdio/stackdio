    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_map_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/storage'), max_length=255, blank=True, null=True)),
                ('top_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_top_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/core_states'), max_length=255, blank=True, null=True)),
                ('overstate_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_overstate_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/core_states'), max_length=255, blank=True, null=True)),
                ('global_overstate_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_global_overstate_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/core_states'), max_length=255, blank=True, null=True)),
                ('pillar_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_pillar_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/storage'), max_length=255, blank=True, null=True)),
                ('global_pillar_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_global_pillar_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/storage'), max_length=255, blank=True, null=True)),
                ('props_file', core.fields.DeletingFileField(default=None, upload_to=stacks.models.get_props_file_path, storage=django.core.files.storage.FileSystemStorage(location=b'/home/stackdio/.stackdio/storage'), max_length=255, blank=True, null=True)),
