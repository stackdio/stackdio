...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StackAccessRule.description'
        db.delete_column(u'stacks_stackaccessrule', 'description')

        # Deleting field 'StackAccessRule.slug'
        db.delete_column(u'stacks_stackaccessrule', 'slug')

        # Deleting field 'StackAccessRule.title'
        db.delete_column(u'stacks_stackaccessrule', 'title')


    def backwards(self, orm):
        # Adding field 'StackAccessRule.description'
        db.add_column(u'stacks_stackaccessrule', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StackAccessRule.slug'
        db.add_column(u'stacks_stackaccessrule', 'slug',
        ...
        # User chose to not deal with backwards NULL issues for 'StackAccessRule.title'
        raise RuntimeError("Cannot reverse this migration. 'StackAccessRule.title' and its values cannot be restored.")
    ...
    models = {
        ...
        u'stacks.stackaccessrule': {
            'Meta': {'object_name': 'StackAccessRule'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'stack': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_rules'", 'to': u"orm['stacks.Stack']"}),
