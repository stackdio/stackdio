...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formula.access_token'
        db.add_column(u'formulas_formula', 'access_token',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Formula.access_token'
        db.delete_column(u'formulas_formula', 'access_token')
    ...
    models = {
        ...
        u'formulas.formula': {
            ...
            'access_token': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
