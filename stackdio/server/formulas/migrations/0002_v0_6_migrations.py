...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formula.git_username'
        db.add_column(u'formulas_formula', 'git_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Formula.git_username'
        db.delete_column(u'formulas_formula', 'git_username')
