...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'formulas_formula', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('model_utils.fields.StatusField')(default='error', max_length=100, no_check_for_status=True)),
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='formulas', to=orm['auth.User'])),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('root_path', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'formulas', ['Formula'])

        # Adding model 'FormulaComponent'
        db.create_table(u'formulas_formulacomponent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='title', overwrite=False)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('formula', self.gf('django.db.models.fields.related.ForeignKey')(related_name='components', to=orm['formulas.Formula'])),
            ('sls_path', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'formulas', ['FormulaComponent'])


    def backwards(self, orm):
        # Deleting model 'Formula'
        db.delete_table(u'formulas_formula')

        # Deleting model 'FormulaComponent'
        db.delete_table(u'formulas_formulacomponent')
