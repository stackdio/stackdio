...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.blueprint_host_definition'
        db.add_column(u'stacks_host', 'blueprint_host_definition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='hosts', to=orm['blueprints.BlueprintHostDefinition']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.blueprint_host_definition'
        db.delete_column(u'stacks_host', 'blueprint_host_definition_id')
