...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudProvider.vpc_id'
        db.add_column(u'cloud_cloudprovider', 'vpc_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudProvider.vpc_id'
        db.delete_column(u'cloud_cloudprovider', 'vpc_id')
