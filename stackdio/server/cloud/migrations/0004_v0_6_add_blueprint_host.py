...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecurityGroup.stack'
        db.add_column(u'cloud_securitygroup', 'stack',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='security_groups', null=True, to=orm['stacks.Stack']),
                      keep_default=False)

        # Adding field 'SecurityGroup.blueprint_host_definition'
        db.add_column(u'cloud_securitygroup', 'blueprint_host_definition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='security_groups', to=orm['blueprints.BlueprintHostDefinition']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecurityGroup.stack'
        db.delete_column(u'cloud_securitygroup', 'stack_id')

        # Deleting field 'SecurityGroup.blueprint_host_definition'
        db.delete_column(u'cloud_securitygroup', 'blueprint_host_definition_id')
    ...
    models = {
        ...
        u'cloud.securitygroup': {
            ...
            'blueprint_host_definition': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'security_groups'", 'to': u"orm['blueprints.BlueprintHostDefinition']"}),
