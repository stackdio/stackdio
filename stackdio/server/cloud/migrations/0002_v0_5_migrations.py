...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecurityGroup.is_managed'
        db.add_column(u'cloud_securitygroup', 'is_managed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecurityGroup.is_managed'
        db.delete_column(u'cloud_securitygroup', 'is_managed')
