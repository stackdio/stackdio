...
_ZOMBIE_HOST=$BS_FALSE

while getopts ":hvnDc:g:k:MSNXCPFUKIA:i:Lp:Z" opt
do
  case "${opt}" in
...
if [ $_ZOMBIE_HOST -eq $BS_TRUE ]; then
    echoerror "Congrats, you've created a zombie!"
    exit 90
fi
