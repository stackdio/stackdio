...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlueprintHostDefinition.spot_price'
        db.add_column(u'blueprints_blueprinthostdefinition', 'spot_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlueprintHostDefinition.spot_price'
        db.delete_column(u'blueprints_blueprinthostdefinition', 'spot_price')
