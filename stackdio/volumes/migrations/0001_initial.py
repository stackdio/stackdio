...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'volumes_volume', (
            ...
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='volumes', null=True, to=orm['stacks.Host'])),
    ...
    models = {
        ...
        u'volumes.volume': {
            ...
            'host': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'volumes'", 'null': 'True', 'to': u"orm['stacks.Host']"}),
            'hostname': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
