...
def __virtual__():
    ...
    return 'stack_pillar' if 'stack_pillar_file' in __grains__ else False
...
def ext_pillar(pillar, *args, **kwargs):
    ...
    try:
        ...
        logger.exception(e)
        logger.critical('Unable to load/render stack_pillar_file. Is the YAML properly formatted?')
        d = {}
